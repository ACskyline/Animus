...
private:
	...
	void glSetUpMesh();
	void glSetUpBuffers();//new
	void glSetUpAttribs(GLint position, GLint normal, GLint texcoord, GLint vMatrix);//new
...
public:
	...
	void glSetUp(int _instanceCount, const glm::vec3 &translation, const glm::vec3 &stride, GLint position, GLint normal, GLint texcoord, GLint vMatrix);//new
